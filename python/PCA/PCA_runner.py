...
class SimulationRunner():
    def __init__(self):
        spec = importlib.util.spec_from_file_location("module.name","/home/anne/Documents/featurecloud/code/import_export/import_data.py")
...
if __name__=="__main__":
    ...
    parser.add_argument('-v', metavar='variance', type=bool,
                        help='Scale variables to unit variance', default=True)
    parser.add_argument('-u', metavar='unitnorm', type=bool,
                        help='Scale samples to unit norm', default=True)
    parser.add_argument('-z', metavar='scale01', type=bool,
                        help='Scale variables between 0 and 1', default=False)
    parser.add_argument('-t', metavar='center', type=bool,
