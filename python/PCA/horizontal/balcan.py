...
if __name__ == '__main__':
    ...
    data_list, choice = sh.partition_data_horizontally(ds, splits=20, randomize=False)
    data_list, choice = sh.partition_data_horizontally(data, splits=20, randomize=False)
    ...
    x, e = simulate_federated_horizontal_pca(data_list, k=20, factor_k=3)
