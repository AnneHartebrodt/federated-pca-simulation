...
Rscript $basedir/R/vertical-pca-benchmark/data_cleanup/read_data.R -b . -s 'angles.u' -c $colname -o $outfile1
Rscript $basedir/R/vertical-pca-benchmark/data_cleanup/aggregate_data.R -f $outfile1 -o 'angles.u.summary.tsv' -c $colname


outfile1='angles.v.tsv'
outfile2='angles.v.summary.tsv'
Rscript $basedir/R/vertical-pca-benchmark/data_cleanup/read_data.R -b . -s 'angles.v' -c $colname -o $outfile1
...
colname='conv'
Rscript $basedir/R/vertical-pca-benchmark/data_cleanup/read_data.R -b . -s $colname -c $colname -o $outfile1
Rscript $basedir/R/vertical-pca-benchmark/data_cleanup/aggregate_data.R -f $outfile1 -o $outfile2  -c $colname
