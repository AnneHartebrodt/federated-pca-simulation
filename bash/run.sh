#!/bin/bash
python3.7 -m PCA.PCA_runner -d 10 -p ~/federated_DP_PCA/results/simulation_breast/suball_d/ -f ~/federated_DP_PCA/data/tcga_breast/data/coding_only.txt -k 5 -s -r 2 -c -i 0 -v -u -t -A -B -C -e 0.01,0.1,0.5,1 -g 0.1,1
