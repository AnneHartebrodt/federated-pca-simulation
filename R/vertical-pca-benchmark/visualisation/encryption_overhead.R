...
encryption<-fread('/home/anne/Documents/featurecloud/pca/vertical-pca/results/qr_encryption/benchmark_encryption_qr_encryption')
encryption2<-fread('/home/anne/Documents/featurecloud/pca/vertical-pca/results/qr_encryption/benchmark_encryption_qr_encryption_encrypted')
...
nr_sites = 5
barchart <- ggplot(summary[encrypted %in% c('addition', 'decryption', 'encryption', 'setup') & sites %in% c(nr_sites)], 
...
angles<-fread('/home/anne/Documents/featurecloud/pca/vertical-pca/results/qr_encryption/benchmark_encryption_qr_angles_11.tsv')
angles<- angles %>% pivot_longer(-c(V1,V2, V3))
angles<-as.data.table(angles)
angles<-angles[!is.na(value)]
mean(angles$value)

angles_enc <- fread('/home/anne/Documents/featurecloud/pca/vertical-pca/results/qr_encryption/benchmark_encryption_qr_angles_22.tsv')
...
enc_vs_unenc<-fread('/home/anne/Documents/featurecloud/pca/vertical-pca/results/qr_encryption/benchmark_encryption_qr_angles_12.tsv')
...
enc_vs_unenc<-fread('/home/anne/Documents/featurecloud/pca/vertical-pca/results/qr_encryption/benchmark_encryption_qr_angles_scipy_fed.tsv')
enc_vs_unenc<- enc_vs_unenc %>% pivot_longer(-c(V1,V2, V3))
enc_vs_unenc<-as.data.table(enc_vs_unenc)
enc_vs_unenc<- enc_vs_unenc[!is.na(value)]
sum(enc_vs_unenc$value)
